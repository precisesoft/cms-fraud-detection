...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-x-auto rounded-lg neu-recessed"
    >
      <table
        data-slot="table"
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-3 text-left align-middle label-stamped text-[10px] [&:has([role=checkbox])]:pr-0",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "px-3 py-2 align-middle whitespace-nowrap text-sm [&:has([role=checkbox])]:pr-0",
        className,
      )}
      {...props}
    />
