...
COLUMN_MAPS: dict[str, dict[str, str]] = {
    ...
    "part_b_provider": {
        ...
        "Rndrng_Prvdr_Type": "provider_type",
        "Rndrng_Prvdr_Mdcr_Prtcptg_Ind": "medicare_participating_ind",
        "Tot_HCPCS_Cds": "tot_hcpcs_cds",
        "Tot_Benes": "tot_benes",
        "Tot_Srvcs": "tot_srvcs",
        "Tot_Sbmtd_Chrg": "tot_submitted_charge",
        "Tot_Mdcr_Alowd_Amt": "tot_medicare_allowed_amt",
        "Tot_Mdcr_Pymt_Amt": "tot_medicare_payment_amt",
    },
    ...
    "enrollment": {
        ...
        "STATE_CD": "state_cd",
        "ENRLMT_STUS_EFCTV_DT": "enrlmt_stus_efctv_dt",
        "ENRLMT_END_DT": "enrlmt_end_dt",
        "MDCR_STUS_CD": "mdcr_stus_cd",
    },
    # CMS Medicare Revocation / Opt-Out file
    "revocations": {
        "NPI": "npi",
        "REVOCATION_RSN": "revocation_rsn",
    },
}
